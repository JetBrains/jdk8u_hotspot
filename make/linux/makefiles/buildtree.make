...
flags.make: $(BUILDTREE_MAKE) ../shared_dirs.lst
	...
	echo "$(call gamma-path,altsrc,cpu/aarm64/vm) \\"; \
	echo "$(call gamma-path,commonsrc,cpu/aarm64/vm) \\"; \
	echo "$(call gamma-path,altsrc,os_cpu/$(OS_FAMILY)_aarm64/vm) \\"; \
	echo "$(call gamma-path,commonsrc,os_cpu/$(OS_FAMILY)_aarm64/vm) \\"; \
