...
class ShenandoahAllocRequest : public StackObj {
public:
  enum Type {
...
public:
  static inline ShenandoahAllocRequest for_tlab(size_t requested_size) {
    return ShenandoahAllocRequest(requested_size, requested_size, _alloc_tlab);
  }
